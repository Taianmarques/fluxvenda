...
import { Rocket, Clock, Pencil, Check, X, Loader2, ChevronDown } from "lucide-react";
            ...
            <div key={s.id} className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-amber-300/80 flex items-center gap-1.5 mt-0.5"><Clock size={11} className="flex-shrink-0" /> {s.whenLabel}</p>
                </div>
