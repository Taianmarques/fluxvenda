...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ agentId: string }> }) {
  ...
  return NextResponse.json({
    ...
    prevendaVeiculoEnabled: config.prevendaVeiculoEnabled,
    prevendaVeiculoRestricoes: config.prevendaVeiculoRestricoes,
    prevendaEtapaVeiculoEnabled: config.prevendaEtapaVeiculoEnabled,
    prevendaEtapaQualificacaoEnabled: config.prevendaEtapaQualificacaoEnabled,
    prevendaEtapaDocumentosEnabled: config.prevendaEtapaDocumentosEnabled,
...
const schema = z.object({
  ...
  prevendaVeiculoEnabled: z.boolean().optional(),
  prevendaVeiculoRestricoes: z.string().max(1000).optional(),
  prevendaEtapaVeiculoEnabled: z.boolean().optional(),
  prevendaEtapaQualificacaoEnabled: z.boolean().optional(),
  prevendaEtapaDocumentosEnabled: z.boolean().optional(),
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ agentId: string }> }) {
  ...
  return NextResponse.json({
    ...
    prevendaVeiculoEnabled: updated.prevendaVeiculoEnabled,
    prevendaVeiculoRestricoes: updated.prevendaVeiculoRestricoes,
    prevendaEtapaVeiculoEnabled: updated.prevendaEtapaVeiculoEnabled,
    prevendaEtapaQualificacaoEnabled: updated.prevendaEtapaQualificacaoEnabled,
    prevendaEtapaDocumentosEnabled: updated.prevendaEtapaDocumentosEnabled,
