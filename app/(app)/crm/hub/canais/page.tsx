...
import { CanaisClient } from "@/app/(app)/crm/canais/CanaisClient";

// Mesma tela de app/(app)/crm/[agentId]/canais, só que sem exigir um agentId na URL —
// alcançável direto do Hub mesmo com zero agentes, pra criar+conectar o primeiro canal
// sem passar pelo formulário completo de setor/nome antes.
export default function CanaisSemAgentePage() {
  return (
