...
const VIEWS: DashboardView[] = ["vendas", "visaogeral", "multiatendimento", "agendamentos", "funil"];
    ...
    return (
      <div className="h-full bg-gray-950 p-6 flex items-center justify-center">
        <div className="max-w-md text-center space-y-4">
          ...
          <p className="text-gray-400">Conecte o WhatsApp ou Instagram do seu agente para ver os dashboards aqui.</p>
