...
export default function DashboardsPage(props: { params: Promise<{ agentId: string }> }) {
  return (
...
async function DashboardsPageContent({ params }: { params: Promise<{ agentId: string }> }) {
    ...
    <div className="h-full overflow-y-auto bg-gray-950 text-white p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-400 mt-1">Resumo de atendimento, equipe, leads e vendas dos últimos 30 dias.</p>
        </div>
