...
export function OpportunitiesPanel({
  ...
  return (
    <div
      ref={ref}
      className={`max-md:fixed max-md:inset-x-3 max-md:top-28 md:absolute md:top-full md:right-0 md:mt-1 md:w-72 rounded-xl border shadow-xl z-30 max-h-96 flex flex-col ${dark ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"}`}
    >
