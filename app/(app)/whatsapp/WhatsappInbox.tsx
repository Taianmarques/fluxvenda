...
export function WhatsappInbox({ agentName, initialConversations }: { agentName: string; initialConversations: ConversationSummary[] }) {
    ...
    try {
      ...
      if (data.conversations) {
        setConversations(data.conversations.map((c: any) => ({
          ...
          status: c.status, humanTakeover: c.humanTakeover, updatedAt: c.updatedAt,
