import {
  ...
  Megaphone, Phone, Coins, BookUser, BookOpen, LayoutDashboard, CalendarCheck, BarChart3, Goal, User, MessageSquareText, type LucideIcon,
} from "lucide-react";
...
export type CrmPageKey =
  ...
  | "automacao" | "condicoes"
  | "canais" | "equipe" | "auditoria" | "creditos" | "conhecimento" | "metas" | "respostasrapidas";
...
export const CRM_CATEGORIES: CrmCategoryDef[] = [
  ...
  { key: "configuracoes", label: "Configurações", variant: "flyout", pages: [
    ...
    { key: "respostasrapidas", label: "Mensagens Rápidas", suffix: "/respostas-rapidas", icon: MessageSquareText },
