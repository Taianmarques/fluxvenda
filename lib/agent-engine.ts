...
export const COMMERCE_TOOLS = [
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: { busca: { type: "string", description: "Termo opcional pra filtrar por nome, marca, modelo, cor ou descrição. Categorias (SUV, picape, sedã, hatch, minivan...) também são filtradas pelo campo Carroceria do cadastro — use o termo do cliente em busca. Se nenhum item vier marcado com a categoria, o catálogo completo volta e você identifica pelos modelos quais se encaixam." } },
        required: [],
      },
    },
  },
