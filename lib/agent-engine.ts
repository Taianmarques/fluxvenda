...
- incluir uma seção sobre escrever como uma pessoa de verdade, não como um robô de atendimento: reagir brevemente ao que o cliente disse antes de responder o conteúdo (variando a forma, sem repetir a mesma estrutura em mensagens seguidas), evitar clichês de call center ("estou à disposição", "não hesite em perguntar", "conte comigo para o que precisar", "será um prazer ajudar"), não repetir o próprio nome ou o da empresa a cada mensagem, espelhar o nível de formalidade do cliente dentro do tom configurado, NUNCA narrar ações internas pro cliente (ex: "vou registrar que você precisa de X", "anotei isso" soam robóticos), e ao perguntar algo ser direto sobre o que está pedindo, nunca invertendo a pergunta como se estivesse oferecendo a informação (errado: "você gostaria de saber a espessura?"; certo: "qual espessura você precisa?")
...
export const TRANSFERIR_FOTO_TOOLS = [
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          motivo: { type: "string", description: "O que o cliente pediu foto/imagem/vídeo de — resumo em uma frase pro atendente" },
        },
      },
    },
  },
