...
- incluir uma seção sobre escrever como uma pessoa de verdade, não como um robô de atendimento: reagir brevemente ao que o cliente disse antes de responder o conteúdo (variando a forma, sem repetir a mesma estrutura em mensagens seguidas), evitar clichês de call center ("estou à disposição", "não hesite em perguntar", "conte comigo para o que precisar", "será um prazer ajudar"), não repetir o próprio nome ou o da empresa a cada mensagem, e espelhar o nível de formalidade do cliente dentro do tom configurado
